...
| `LanguageServer/` | ide | LSP server, including shared native/LSP file-watch aggregation and backend adapters; see the IDE instruction file for directory detail. |
