...
";
            ...
            string MakeHelixWorkItemProject(WorkItemInfo workItemInfo)
            {
                ...
                if (options.TestVsi)
                {
                    ...
                    command.AppendLine($"./eng/setup-integration-test.ps1 -configuration {options.Configuration} -oop64bit:${options.Oop64Bit} -oopCoreClr:${options.OopCoreClr} -lspEditor:${options.LspEditor} -ci:$true");
                }
                ...
                if (options.TestVsi)
                {
                    ...
                    postCommands.AppendLine($"xcopy {testResultsDirectory} %HELIX_WORKITEM_UPLOAD_ROOT% /E");
                }
