...
internal class ExampleLanguageServer : AbstractLanguageServer<ExampleRequestContext>
{
    ...
    public ExampleLanguageServer(JsonRpc jsonRpc, IProtocolSerializer jsonSerializer, ILspLogger logger, Action<IServiceCollection>? addExtraHandlers) : base(jsonRpc, jsonSerializer, logger)
    {
    ...
    protected override ILspServices ConstructLspServices()
    {
        ...
        var _ = AddHandlers(serviceCollection)
            ...
            .AddSingleton<AbstractHandlerProvider>(s => GetHandlerProvider())
