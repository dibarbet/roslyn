...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.Diagnostics
{
    ...
    internal abstract class AbstractPullDiagnosticHandler<TDiagnosticsParams, TReport, TReturn> : IRequestHandler<TDiagnosticsParams, TReturn?>
    {
        /// <summary>
        ...
        private LSP.Diagnostic ConvertDiagnostic(Document document, SourceText text, DiagnosticData diagnosticData, ClientCapabilities clientCapabilities)
        {
