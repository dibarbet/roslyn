    ...
    where TDiagnosticsParams : IPartialResultParams<TReport>
{
    ...
    /// </summary>
    protected virtual Task WaitForChangesAsync(RequestContext context, string? category, CancellationToken cancellationToken)
    {
        ...
        TDiagnosticsParams diagnosticsParams, RequestContext context, CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            await WaitForChangesAsync(context, category, cancellationToken).ConfigureAwait(false);
