...
namespace Microsoft.CodeAnalysis.LanguageServer.Handler.Implementation
{
    ...
    internal class PreviewCodeActionsHandler : CodeActionsHandlerBase<RunCodeActionParams, LSP.TextEdit[]>
    {
        ...
        public override async Task<LSP.TextEdit[]> HandleRequestAsync(Solution solution, RunCodeActionParams request,
