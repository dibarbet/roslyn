...
{
    internal abstract class CodeActionsHandlerBase<RequestType, ResponseType> : IRequestHandler<RequestType, ResponseType>
    {
        ...
        public abstract Task<ResponseType> HandleRequestAsync(Solution solution, RequestType request, LSP.ClientCapabilities clientCapabilities, CancellationToken cancellationToken);
