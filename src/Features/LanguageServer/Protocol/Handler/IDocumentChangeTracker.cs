...
{
    ValueTask StartTrackingAsync(Uri documentUri, SourceText initialText, LanguageInformation? languageInformation, CancellationToken cancellationToken);
...
{
    public ValueTask StartTrackingAsync(Uri documentUri, SourceText initialText, LanguageInformation? languageInformation, CancellationToken cancellationToken)
    {
