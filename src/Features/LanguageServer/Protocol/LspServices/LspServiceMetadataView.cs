...
internal class LspServiceMetadataView
{
    ...
    {
        var handlerMetadata = (Type)metadata[nameof(ExportLspServiceAttribute.Type)];
        Type = handlerMetadata;

        ServerKind = (WellKnownLspServerKinds)metadata[nameof(ExportLspServiceAttribute.ServerKind)];
    }
