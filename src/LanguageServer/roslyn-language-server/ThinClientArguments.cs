...
{
    private const string DaemonModeEnvironmentVariableName = "ROSLYN_LANGUAGE_SERVER_DAEMON";
    ...
    public static ThinClientArguments Parse(string[] args)
    {
        ...
        var daemonMode = Environment.GetEnvironmentVariable(DaemonModeEnvironmentVariableName) == "1";
