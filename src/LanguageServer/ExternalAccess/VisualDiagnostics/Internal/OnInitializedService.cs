...
internal sealed class OnInitializedService : ILspService, IServiceBrokerInitializer, IDisposable
{
    ...
    {
        _lspWorkspaceRegistrationService = lspServices.GetRequiredService<LspWorkspaceRegistrationService>();
    }
