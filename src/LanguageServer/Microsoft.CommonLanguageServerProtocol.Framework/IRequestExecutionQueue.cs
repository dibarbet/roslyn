...
internal interface IRequestExecutionQueue<TRequestContext> : IAsyncDisposable
{
    ...
    Task<object?> ExecuteAsync<TRequest>(TRequest request, string methodName, DelegatingEntryPoint<TRequestContext> entryPoint, ILspServices lspServices, CancellationToken cancellationToken);
