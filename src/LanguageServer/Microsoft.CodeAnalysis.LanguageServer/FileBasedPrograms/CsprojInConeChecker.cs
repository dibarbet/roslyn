...
[ExportLspService(typeof(CsprojInConeChecker), ProtocolConstants.RoslynLspLanguagesContract), Shared(ProtocolConstants.LspServerInstanceSharingBoundary)]
internal sealed class CsprojInConeChecker : ILspService, IOnInitialized
{
    [ImportingConstructor]
    [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
    public CsprojInConeChecker()
    {
    }
