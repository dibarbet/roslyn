...
[ExportCSharpVisualBasicLspService(typeof(RazorStartupService)), Shared(ProtocolConstants.LspServerInstanceSharingBoundary)]
[method: ImportingConstructor]
internal sealed class RazorStartupService(
    [Import(AllowDefault = true)] IUIContextActivationService? uIContextActivationService,
    [ImportMany] IEnumerable<Lazy<IRazorCohostStartupService>> lazyStartupServices) : ILspService, IOnInitialized, IDisposable
