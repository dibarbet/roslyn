...
namespace Microsoft.VisualStudio.LanguageServices.Xaml.LanguageServer
{
    ...
    /// </summary>
    [ExportLspServiceFactory(typeof(RequestDispatcher), StringConstants.XamlLspLanguagesContract)]
    ...
    [ExportLspServiceFactory(typeof(LspWorkspaceManager), StringConstants.XamlLspLanguagesContract)]
    ...
    [ExportLspServiceFactory(typeof(RequestTelemetryLogger), StringConstants.XamlLspLanguagesContract)]
    ...
    internal class ExportXamlLspRequestHandlerProviderAttribute : ExportLspServiceAttribute
    {
        public ExportXamlLspRequestHandlerProviderAttribute(Type handlerType) : base(handlerType, StringConstants.XamlLspLanguagesContract, WellKnownLspServerKinds.XamlLspServer)
        {
        }
    }
}
