...
namespace Microsoft.VisualStudio.LanguageServices.Implementation.LanguageService
{
    ...
    internal abstract class LanguageServerClient : ILanguageClient
    {
        private const string ServiceHubClientName = "ManagedLanguage.IDE.RoslynLanguageServer";
...
#pragma warning restore CS0067 // event never used
        ...
        public async Task<Connection> ActivateAsync(CancellationToken cancellationToken)
        {
            ...
            var stream = await ServiceHubRemoteHostClient.Connections.RequestServiceAsync(
                _workspace,
                hubClient,
                WellKnownServiceHubServices.RoslynLanguageServer,
                hostGroup,
